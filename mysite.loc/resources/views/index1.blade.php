...
<div class="modal fade" id="loginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="width: 469px;">
            ...
            <div class="col-xs-12" style="text-align: left">
                <a href="#" class="forgotPassword" id="forgotPasswordMy" data-dismiss="modal">Вспомнить пароль</a>
            </div>
...
<!--forgot pass modal-->
<div class="modal fade" id="forgotModal" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                ...
                <nav class="navbar bottom_menu" role="navigation">
                    ...
                    <div id="main-nav" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar_ul" id="mainNav">
                            <li><a href="/course" class="scroll-link">КУРСЫ</a></li>
                            <li><a href="/olympics" class="scroll-link">ОЛИМПИАДЫ</a></li>
                            <li><a href="/webinars" class="scroll-link">ВЕБИНАРЫ</a></li>
                            <li><a href="/tests" class="scroll-link">ПЕДТЕСТЫ</a></li>
                            <li><a href="/quiz" class="scroll-link">ВИКТОРИНЫ</a></li>
                            <li><a href="/publications" class="scroll-link">ПУБЛИКАЦИИ</a></li>
                        </ul>
...
<?php if($_SERVER['REQUEST_URI'] == "/intelurok"){ ?>
<div class="container-fluid">
    ...
    <div class="col-md-2  sidebar">
        ...
        <div class="profile_inf <?php if($_SERVER['REQUEST_URI'] == "/intelurok/testResults"){echo 'scrolStatic'; } ?>">
            <div class="my_cabinet">
                <ul class="sidebar-nav nav">
                    ...
                    <li>
                        <a href="/publications/my_publications" data-scroll>Публикации</a>
                    </li>
                    <li>
        ...
        <?php if($_SERVER['REQUEST_URI'] == "/intelurok" || $_SERVER['REQUEST_URI'] == "/intelurok/quiz"){ ?>
        ...
        <?php } else if($_SERVER['REQUEST_URI'] == "/intelurok/archive" || $_SERVER['REQUEST_URI'] == "/intelurok/my_applications" || $_SERVER['REQUEST_URI'] == "/intelurok/rewards"){ ?>
    ...
    <?php if(
    $_SERVER['REQUEST_URI'] == "/intelurok/webinars" ||
    $_SERVER['REQUEST_URI'] == "/intelurok/webinar" ||
    $_SERVER['REQUEST_URI'] == "/intelurok/tests" ||
    $_SERVER['REQUEST_URI'] == "/intelurok/elaboration" ||
    $_SERVER['REQUEST_URI'] == "/intelurok/my_publications" ||
    $_SERVER['REQUEST_URI'] == "/intelurok/add_publication" ||
    $_SERVER['REQUEST_URI'] == "/intelurok/publication" ||
    $_SERVER['REQUEST_URI'] == "/intelurok/test"
    ){ ?>
    ...
    <div class="col-md-3 col-sm-3 blocks">
        <div class="block_menu">
            <ul class="sidebar-nav nav">
                ...
                <li>
                    <a href="<?php if($_SERVER['REQUEST_URI'] == "/quiz" || $_SERVER['REQUEST_URI'] == "/add_application_quiz"){echo "/quiz/add_application";}else{echo "/olympics/add_application";} ?>" data-scroll>Подать заявку</a>
                </li>
                <li>
                    <a href="/applications/my_application" data-scroll>Мои заявки</a>
                </li>
                <li>
                    <a href="/results" data-scroll>Результаты и награды</a>
                </li>
                <li>
                    <a href="/rewards" data-scroll>
                        <?php if($_SERVER['REQUEST_URI'] == "/quiz" || $_SERVER['REQUEST_URI'] == "/add_application_quiz"){
                            echo "Архив викторин";
                        }else{
                            echo "Архив олимпиад";
                        }
        ...
        <?php if($_SERVER['REQUEST_URI'] == "/quiz"){ ?>
