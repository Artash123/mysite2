...
@section('content')
        <div class="application_content">
            ...
            <div class="col-grey">
                <div id="animation">
                    <img src="/images/add_anim/1.png" alt="" class="plus minus">
                    <img src="/images/add_anim/2.png" alt="" class="plus">
                    <img src="/images/add_anim/3.png" alt="" class="plus">
                    <img src="/images/add_anim/4.png" alt="" class="plus">
                    <img src="/images/add_anim/5.png" alt="" class="plus">
                    <img src="/images/add_anim/6.png" alt="" class="plus">
                    <img src="/images/add_anim/7.png" alt="" class="plus">
                    <img src="/images/add_anim/8.png" alt="" class="plus">
                    <img src="/images/add_anim/9.png" alt="" class="plus">
                    <img src="/images/add_anim/10.png" alt="" class="plus">
                </div>
                <h6>Количество участников</h6>
                <div class="number-wrp">
                    <div id="minus" class="btn gray">–</div>
                    <input type="text" maxlength="2" min="0" name="count" id="n-of-members" class="" data-vv-id="4" aria-required="true" aria-invalid="false">
